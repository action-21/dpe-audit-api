...
use App\Domain\Chauffage\Engine\Dimensionnement\{ConfigurationSysteme, DimensionnementGenerateur, DimensionnementInstallation, DimensionnementSysteme};
use App\Domain\Chauffage\Engine\Rendement\{RendementInstallation, RendementSysteme};
...
final class ConsommationChauffage extends EngineRule
{
    private Audit $audit;
    ...
    /**
     * @see \App\Domain\Chauffage\Engine\Rendement\RendementSysteme::ich()
     */
    ...
    /**
     * @see \App\Domain\Chauffage\Engine\Rendement\RendementInstallation::fch()
     */
