...
final class XMLPontThermiqueDeserializer
{
    public function deserialize(XMLElement $xml, Enveloppe $entity): PontThermique
    {
        $reader = XMLPontThermiqueReader::from($xml);
