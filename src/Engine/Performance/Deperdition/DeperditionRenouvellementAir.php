...
use App\Engine\Performance\Scenario\ZoneThermique;
use App\Engine\Performance\SurfaceDeperditive\SurfaceDeperditiveEnveloppe;
use App\Engine\Performance\Ventilation\PerformanceVentilation;

final class DeperditionRenouvellementAir extends Rule
{
    private Audit $audit;
    ...
    /**
     * @see \App\Engine\Performance\Scenario\ZoneThermique::hauteur_sous_plafond()
     */
    ...
    /**
     * @see \App\Engine\Performance\Scenario\ZoneThermique::volume_habitable()
     */
    ...
    /**
     * @see \App\Engine\Performance\Deperdition\DeperditionParoi::sdep()
     */
     ...
     * 
     * @see \App\Engine\Performance\Deperdition\DeperditionParoi::sdep()
     * @see \App\Engine\Performance\Deperdition\DeperditionParoi::isolation()
     */
     ...
     * 
     * @see \App\Engine\Performance\Ventilation\PerformanceVentilation::qvarep_conv()
     */
     ...
     * 
     * @see \App\Engine\Performance\Ventilation\PerformanceVentilation::qvasouf_conv()
     */
     ...
     * 
     * @see \App\Engine\Performance\Ventilation\PerformanceVentilation::smea_conv()
     */
