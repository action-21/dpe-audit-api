...
final class RendementChaudiereBasseTemperature extends RendementChaudiere
{
    ...
    public static function match(Systeme $systeme): bool
    {
        return parent::match($systeme)
            && $systeme->generateur()->combustion()->mode_combustion === ModeCombustion::BASSE_TEMPERATURE
